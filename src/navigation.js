...
import BooingInformation from './controllers/bookingInformationController';
        ...
        <NavigationContainer>
            <Stack.Navigator>
                ...
                <Stack.Screen
                    ...
                    options={({ navigation }) => setHeader(navigation, '예약정보', Entypo)}
                />
                <Stack.Screen
                    name="Update"
                    component={Update}
                ...
                />
                <Stack.Screen
                    name="BooingInformation"
                    component={BooingInformation}
                    options={({ navigation }) => setHeader(navigation, '예약정보확인', FontAwesome, 'user')}
                />
                <Stack.Screen
                    name="Map"
                    component={Map}
                    options={({ navigation }) => setHeader(navigation, '배송추적', Entypo)}
                />
                <Stack.Screen
                    name="QRCode"
                    component={QRCode}
                ...
                <Stack.Screen
                    name="Details"
                    component={Details}
                    options={({ navigation }) => setHeader(navigation, '예약자정보', Entypo)}
                />
            </Stack.Navigator>
        </NavigationContainer>
    )
